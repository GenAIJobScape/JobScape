...
export const HypothesisData: IHypothesisContentProps = {
  data: {
    ...
    contents: [
      {
        id: 'experience-preference-trend',
        title: '1. 전체 산업의 경력 선호 추세',
        contents: [
          {
            id: 'experience-preference-trend-details',
            type: 'ul',
            data: [
              {
                id: 'posting-ratio-comparison',
                item: '동일 기간 대비 신입보다 경력 공고의 비중이 높게 나타납니다.',
              },
              {
                id: 'hiring-unit-superiority',
      ...
      {
        id: 'it-sw-field-specificity',
        title: '2. IT/SW 분야의 특이성',
        contents: [
          {
            id: 'it-sw-field-specificity-details',
            type: 'ul',
            data: [
              {
                id: 'minimizing-adaptation-time',
                item: '개발·데이터·인프라 등 SW 직무군은 업무 투입까지의 적응 시간과 리스크를 최소화하려는 경향이 강합니다.',
              },
              {
                id: 'practical-compatibility-indicators',
      ...
      {
        id: 'plug-and-play-preference',
        title: '3. 즉시 투입 가능성(Plug-and-Play) 선호',
        contents: [
          {
            id: 'plug-and-play-preference-details',
            type: 'ul',
            data: [
              {
                id: 'new-hire-cost-increase',
                item: '신입 채용 시 필요한 교육·멘토링·품질 검증 비용이 커져, 프로젝트 일정 압박이 큰 팀일수록 경력 선호가 강화됩니다.',
              },
              {
                id: 'flexible-employment-impact',
      ...
      {
        id: 'hiring-method-change',
        title: '4. 채용 방식 변화',
        contents: [
          {
            id: 'hiring-method-change-details',
            type: 'ul',
            data: [
              {
                id: 'shift-to-practical-verification',
                item: '상시채용·수시채용 전환, 레퍼럴 강화, 과제 기반 실무 테스트 등 실무 검증 중심으로 바뀌고 있습니다.',
              },
              {
                id: 'need-for-objective-compatibility',
      ...
      },
      {
        ...
        contents: [
          {
            id: 'overall-conclusion-details',
            type: 'ul',
            data: [
              {
                id: 'experience-ratio-superiority',
      ...
      },
      {
        ...
        contents: [
          {
            id: 'data-and-methods-details',
            type: 'ul',
            data: [
              {
                id: 'analysis-data-source',
      ...
      },
      {
        ...
        contents: [
          {
            id: 'implications-details',
            type: 'ul',
            data: [
              {
                id: 'implication-for-job-seekers',
                item: '구직자(신입): 포트폴리오(실서비스·배포 링크·성능지표), 팀협업 경험, 코드 품질(테스트·CI/CD)로 현업 호환성을 증명하세요.',
              },
              {
                id: 'implication-for-companies',
...
export const HypothesisData2: IHypothesisContentProps = {
  data: {
    id: 'visualization-1-job-posting-fluctuation',
    title:
      '시각화 1: IT 업계 채용 공고 수 증감률 (2024년 1분기 대비 2025년 1분기)',
    type: 'ol',
    contents: [
      {
        id: 'v1-hypothesis-verification',
        title: '가설 검증',
        contents: [
          {
            id: 'v1-hypothesis-text',
            type: 'text',
...
export const HypothesisData3: IHypothesisContentProps = {
  data: {
    id: 'visualization-2-experience-ratio-change',
    title:
      '시각화 2: IT 개발 직무 채용 공고 중 경력직 비중 변화 (2024년 1분기 vs. 2025년 1분기)',
    type: 'ol',
    contents: [
      {
        id: 'v2-hypothesis-verification',
        title: '가설 검증',
        contents: [
          {
            id: 'v2-hypothesis-text',
            type: 'text',
...
export const HypothesisData4: IHypothesisContentProps = {
  data: {
    id: 'visualization-3-experience-ratio-by-type',
    title:
      '시각화 3: 2025년 1분기 IT 개발 및 데이터 관련 구인 공고의 경력 유형별 비중',
    type: 'ol',
    contents: [
      {
        id: 'v3-hypothesis-verification',
        title: '가설 검증',
        contents: [
          {
            id: 'v3-hypothesis-text',
            type: 'text',
...
export const HypothesisData5: IHypothesisContentProps = {
  data: {
    id: 'visualization-4-hiring-ratio-by-industry',
    title:
      '시각화 4: 2023년 산업 분야별 경력자/신입자 채용 비중 (소프트웨어 산업 강조)',
    type: 'ol',
    contents: [
      {
        id: 'v4-hypothesis-verification',
        title: '가설 검증',
        contents: [
          {
            id: 'v4-hypothesis-text',
            type: 'text',
...
export const HypothesisData6: IHypothesisContentProps = {
  data: {
    id: 'visualization-5-recruitment-ratio-by-industry',
...
export const HypothesisData7: IHypothesisContentProps = {
  title: '종합 분석 및 결론 도출',
  data: {
    id: 'final-analysis-and-conclusion',
    title: 'AI 시대, IT 개발자 채용 시장 요약 (2023년~2025년 1분기)',
    type: 'ol',
    contents: [
      {
        id: 'conclusion-new-hire-opportunity-decline',
        title: '1. 신입 채용 기회 급감',
        contents: [
          {
            id: 'conclusion-new-hire-opportunity-decline-text',
            type: 'text',
      ...
      {
        id: 'conclusion-experience-demand-increase',
        title: '2. 경력직 수요 압도적 증가',
        contents: [
          {
            id: 'conclusion-experience-demand-increase-text',
            type: 'text',
      ...
      {
        id: 'conclusion-plug-and-play-preference',
        title: '3. 기업의 즉시 투입 인력 선호',
        contents: [
          {
            id: 'conclusion-plug-and-play-preference-text',
            type: 'text',
      ...
      {
        id: 'conclusion-large-company-hiring-decline',
        title: '4. 대기업 신입 공채 감소',
        contents: [
          {
            id: 'conclusion-large-company-hiring-decline-text',
            type: 'text',
      ...
      {
        id: 'conclusion-final-summary',
        title: '5. 결론',
        contents: [
          {
            id: 'conclusion-final-summary-text',
            type: 'text',
