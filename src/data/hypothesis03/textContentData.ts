...
export const HypothesisData: IHypothesisContentProps = {
  ...
  data: {
  id: 'demand-analysis-1',
    title: 'AI 업무 활용자(IT/개발자)의 위협 인식과 구직자 불안감',
    contents: [
      {
  id: 'industry-shortage-analysis-1',
        title: '내용',
        contents: [
          {
            id: 'industry-shortage-text-1',
            type: 'text',
      ...
      {
  id: 'recruitment-rate-trends-1',
        title: '목적',
        contents: [
          {
            id: 'recruitment-rate-text-1',
            type: 'text',
...
export const HypothesisData2: IHypothesisContentProps = {
  ...
  data: {
  id: 'demand-analysis-2',
    title:
      'IT/개발 직군 내 AI 대체 위협 체감 (업무 활용자, 관리직) 및 예상 시기',
    contents: [
      {
  id: 'industry-shortage-analysis-2',
        title: '내용',
        contents: [
          {
            id: 'industry-shortage-text-2',
            type: 'text',
      ...
      {
  id: 'recruitment-rate-trends-2',
        title: '목적',
        contents: [
          {
            id: 'recruitment-rate-text-2',
            type: 'text',
...
export const HypothesisData3: IHypothesisContentProps = {
  ...
  data: {
  id: 'demand-analysis-3',
    title: 'AI 대체 위협 인식과 실제 IT 직무 채용 감소의 상관 관계',
    contents: [
      {
  id: 'industry-shortage-analysis-3',
        title: '내용',
        contents: [
          {
            id: 'industry-shortage-text-3',
            type: 'text',
      ...
      {
  id: 'recruitment-rate-trends-3',
        title: '목적',
        contents: [
          {
            id: 'recruitment-rate-text-3',
            type: 'text',
